...
#
# Created: Tue Jan 24 12:27:36 2012
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.maxLengthSpinBox.setProperty("value", 40)
        ...
        self.targetLengthSpinBox.setProperty("value", 35)
        ...
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.spatial)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.fixedDesc_2 = QtGui.QLabel(self.spatial)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.fixedDesc_2.sizePolicy().hasHeightForWidth())
        self.fixedDesc_2.setSizePolicy(sizePolicy)
        self.fixedDesc_2.setMaximumSize(QtCore.QSize(16777215, 77))
        self.fixedDesc_2.setWordWrap(True)
        self.fixedDesc_2.setObjectName(_fromUtf8("fixedDesc_2"))
        self.verticalLayout_4.addWidget(self.fixedDesc_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.fixedDesc_2.setText(QtGui.QApplication.translate("Dialog", "Similar to the \"Fixed\" strategy, but targetLength varies over the volume of the origami. At the surface, the target length is surfaceTargetLen. At the center, the target length is centerTargetLen. This encourages folding from the center to the exterior of the origami.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_2.setText(QtGui.QApplication.translate("Dialog", "Breaks the origami into several geometrically contiguous \"stages\" (or allows the user to do so). Stapes on the interior of a stage have intraStageTargetLen while staples connecting stages have interStageTargetLen.", None, QtGui.QApplication.UnicodeUTF8))
