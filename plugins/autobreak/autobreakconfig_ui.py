...
#
# Created: Tue Jan 31 16:57:04 2012
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 0, 276, 251))
        ...
        self.maxLengthLabel = QtGui.QLabel(self.widget)
        ...
        self.maxLengthSpinBox = QtGui.QSpinBox(self.widget)
        ...
        self.targetLengthSpinBox = QtGui.QSpinBox(self.widget)
        ...
        self.targetLengthLabel = QtGui.QLabel(self.widget)
        ...
        self.minLengthLabel = QtGui.QLabel(self.widget)
        ...
        self.minLegLengthSpinBox = QtGui.QSpinBox(self.widget)
