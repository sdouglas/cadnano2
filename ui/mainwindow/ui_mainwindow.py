...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/slicetools/del-last")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDeleteLast.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/paint")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPathPaint.setIcon(icon17)
