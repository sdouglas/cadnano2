...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/autostaple")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/force")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPathPencil.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/insert")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPathInsertion.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/parttools/new-square")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNewSquarePart.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/skip")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPathSkip.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/slicetools/renumber")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRenumber.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/paint")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPathPaint.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/addseq")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPathAddSeq.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/filetools/csv")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExportStaples.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(_fromUtf8(":/pathtools/modify")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionModify.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_fromUtf8(":/parttools/filter-part")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFilterPart.setIcon(icon20)
        ...
        self.actionFilterEndpoint.setText(QtGui.QApplication.translate("MainWindow", " ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(_fromUtf8(":/parttools/filter-strand")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFilterStrand.setIcon(icon23)
        self.actionFilterStrand.setText(QtGui.QApplication.translate("MainWindow", " ", None, QtGui.QApplication.UnicodeUTF8))
        self.actionFilterStrand.setToolTip(QtGui.QApplication.translate("MainWindow", "Strand-selection mode", None, QtGui.QApplication.UnicodeUTF8))
