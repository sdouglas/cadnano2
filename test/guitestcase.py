...
class GUITestCase(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #We have to be careful on whether we do initialize a QApplication, so, we
        #have to store a strong reference in an instance and store whether we did
        #this in the class itself.
        #When initializing again, we should not create another QApplication.
    ...
    def mousePress(self, widget, button=None, position=None, state=None):
        ...
        '''
        self._mouseEvent(QEvent.MouseButtonPress, widget, button, position, state)
    ...
    def mouseRelease(self, widget, button=None, position=None, state=None):
        ...
        '''
        self._mouseEvent(QEvent.MouseButtonRelease, widget, button, position, state)
    ...
    def click(self, widget, button=None, position=None, state=None):
        ...
        '''
        widget.setFocus()
        self.mousePress(widget, button, position, state)
        self.mouseRelease(widget, button, position, state)
    ...
    def _convertKey(self, key):
        ...
        key is one of the qt.Qt.Key_ constants.
...
#===============================================================================
# List to store objects that should elapse (we don't want them to be garbage 
# collected.
#===============================================================================
_toElapse = []
